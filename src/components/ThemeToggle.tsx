...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={() => setDark(d => !d)}
      className="fixed bottom-6 right-6 z-50 p-2.5 rounded-full bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 shadow-md hover:bg-zinc-50 dark:hover:bg-zinc-700 cursor-pointer transition-all duration-500"
